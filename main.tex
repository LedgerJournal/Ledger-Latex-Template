...
\newcommand{\theyear}[0]{201X}
\newcommand{\thevol}[0]{X}
\newcommand{\thedoi}[0]{DOI 10.5195/LEDGER.\theyear.X}
...
%AUTHOR: keywords are OK to show for Review article, will be hidden for publication
\begin{keywords}
\item First key word.
...
%AUTHOR: this is an alternative to using Endnotes
...
%Last, F.
%\newblock {``Title.''}
%\newblock {\em Publication} (XX Month 201X)
%  \url{http://}
...
%add the Creative Commons license footer to the last page
